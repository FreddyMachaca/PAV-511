...
<head>
    ...
    <title>Restaurante Macdoñas</title>
    <!-- Favicon -->
            ...
            <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <address>
                            ...
                            127-0-0-1
                            <br>
                            4151 Av. Tihuanaco Ceja, El Alto
                            <br>
                            (+000) 337-337-3069
                        </address>
                    </div>
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <tr>
                            <td class="col-md-9"><em><?php echo $order->prod_nombre; ?></em></td>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <p><strong><?php echo $total; ?> Bs</strong></p>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-danger">
                                <h4><strong><?php echo $total; ?> Bs</strong></h4>
                            </td>
                        </tr>
                        </tbody>
                    </table>
