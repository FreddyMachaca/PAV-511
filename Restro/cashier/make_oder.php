                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="customer_name" id="custName" onChange="getCustomer(this.value)">
                                        ...
                                        <?php
                                        //Load All Customers
                                        $ret = "SELECT * FROM  rpos_clientes ";
                                        $stmt = $mysqli->prepare($ret);
                                        $stmt->execute();
                                        $res = $stmt->get_result();
                                        while ($cust = $res->fetch_object()) {
                                            ?>
                                            <option><?php echo $cust->cliente_nombre; ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <?php
                            $prod_id = $_GET['prod_id'];
                            $ret = "SELECT * FROM  rpos_productos WHERE prod_id = ?";
                            $stmt = $mysqli->prepare($ret);
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <input type="submit" name="make" value="Hacer orden" class="btn btn-success" value="">
                                </div>
                            </div>
                        </form>
                    </div>
