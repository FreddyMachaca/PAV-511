                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            ...
                            <p class="text-white mt-0 mb-5">Esta es tu página de perfil. Puedes personalizar tu perfil como quieras Y también cambiar la contraseña también</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="Entregar"">
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
